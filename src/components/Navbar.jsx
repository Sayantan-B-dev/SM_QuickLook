...
function Navbar() {
  ...
  <div className="logo-container">
    <h1 className="logo">Study<br/>Materials</h1>
  </div>
  <div className="routes">
    ...
    <Link className="nav-link" to="/cn"><button className="btn">CN</button></Link>
    <Link className="nav-link" to="/os"><button className="btn">OS</button></Link>
    <Link className="nav-link" to="/se"><button className="btn">SE</button></Link>
